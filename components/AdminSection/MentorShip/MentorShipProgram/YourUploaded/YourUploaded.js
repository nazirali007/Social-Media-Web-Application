        ...
        <MDBox sx={{ marginRight: "1rem", width: "100%", display: "flex", justifyContent: "center", alignItems: "center" }}>
            {(data && data.length > 0) ? (
                <MDBox sx={{ borderBottom: '0.5px solid #d9d9d9', width: "60%", display: "flex", flexDirection: "column", justifyContent: "center", }} >
                    {data.map((item, index) => {
                        return (<MDBox key={index} my={1} py={2} px={1} sx={{ borderBottom: openItemId === item?._id ? '' : '1px solid grey', backgroundColor: "#DBDADE", borderRadius: "10px" }}>
                            <ListItem
                                secondaryAction={
                            ...
                            >
                                ...
                                <ListItemText
                                    ...
                                    secondary={openItemId === item?._id ?
                                        <MDTypography fontSize={"0.8rem"} >
